...
@WebServlet("/RiderUpdateDetailServlet")
public class RiderUpdateDetailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private RiderDAO dao;
    public RiderUpdateDetailServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("RiderDetailsUpdate.jsp");
