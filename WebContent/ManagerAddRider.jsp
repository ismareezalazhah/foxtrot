...
<body style="background-color:#f5deb3;">
	...
	<div class="page-wrapper chiller-theme toggled">
	  ...
	  <div class="container-fluid"><h4>Add New Rider</h4><hr></div>
			...
			<div class="container">
				<div class="form-sec">
					  <form action="ManagerAddRiderServlet" method="post">
					      ...
					      <label>Name :</label>
					      <input type="text" class="form-control" name="riderName" value=""/>
					    </div>
					    <div class="form-group">
					      <label>Password :</label>
					      <input type="password" class="form-control" name="riderPassword" value=""/>
					    </div>
					   <div class="form-group">
					      <label>Contact No :</label>
					      <input type="text" class="form-control" name="riderPhone" value=""/>
					    </div>
