...
<br>
	<div class="sidenav">
	<div class="login-main-text"><h2>Warung D'Tebing<br></h2><h3>Online Food Ordering System</h3><br><p>Customer Registration Page</p><br>
	<button name="btn_login" class="btn btn-grey"><a href="index.html">Main Page</a></button><br><br><br> 
	</div>
    </div>
