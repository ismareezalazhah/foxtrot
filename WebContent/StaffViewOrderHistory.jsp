  ...
  <section class="food_section layout_padding">
    <div class="container">
      ...
      <ul class="filters_menu">
        <li class="nav-item">
        	<a class="nav-link" href="StaffViewOrderListServlet">New Order</a>
        </li>
        <li class="nav-item active">
        	<a class="nav-link" href="StaffViewOrderHistoryListServlet">Order History <span class="sr-only">(current)</span></a>
        </li>
      </ul>
