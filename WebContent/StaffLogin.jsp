...
<body>
	<br>
	<div class="sidenav">
	<div class="login-main-text"><h2>Warung D'Tebing<br></h2><h3>Online Food Ordering System</h3><br>
	<button name="btn_login" class="btn btn-grey"><a href="index.html">Back</a></button><br><br><br> 
	</div>
    </div>
      ...
      <div class="main"><div class="col-md-6 col-sm-12"><div class="login-form">      
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                   ...
                   <input type="password" class="form-control" placeholder="Password" name="staffPassword" id="staffPassword" required="required"> <br>
