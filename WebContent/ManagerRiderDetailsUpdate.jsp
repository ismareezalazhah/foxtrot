  ...
  <div class="hero_area">
    ...
    <div class="container">
      <div class="heading_container">
        <h2>
          Rider Details Update
        </h2>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="form_container" >
            <form action="ManagerUpdateRiderServlet" method="post">
              <div>
                <label><b>Rider ID :</b></label>
              ...
              <div>
                ...
                <input type="text" class="form-control" name="riderStatus" value="<c:out value="${ri.riderStatus}" />" readonly/>
              </div>
              <div class="btn_box" >
