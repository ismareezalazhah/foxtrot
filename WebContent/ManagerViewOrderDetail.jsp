  ...
  <div class="limiter"><div class="container-table100"><div class="wrap-table100"><div class="table100 ver2 m-b-110">
	...
	<main>
	   <div class="row">
	    ...
	    <form action="ManagerUpdateProgressServlet" method="post">
	    ...
	    <form action="ManagerAssignRiderServlet" method="post">
	    <input type="hidden" name="orderid" value="<c:out value="${od.orderid}"/>"/>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Assign Rider</b></div>
	    <select name="riderid" style="width:200px; height:35px">
	    <c:forEach items="${rider}" var="r">
		<option value =<c:out value="${r.riderid}"/> ><c:out value="${r.riderid}"/> - <c:out value="${r.riderName}"/></option>
		</c:forEach>
		</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <div class="btn_box" >
	    <button type="submit">Update</button></div></div>
