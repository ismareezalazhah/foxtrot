...
<body class="sub_page">
  ...
  <div class="limiter"><div class="container-table100"><div class="wrap-table100"><div class="table100 ver2 m-b-110">
	...
	<main>
	    ...
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custName}"/></div></div>
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Password</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custPassword}"/></div></div>
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Email</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custEmail}"/></div></div>
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Gender</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custGender}"/></div></div>
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Address</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custAddress}"/></div></div>
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Contact No</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${cust.custPhone}"/></div></div>
	    <hr>
	    <div class="row">
	      <div class="col-sm-12"> 
	        <a href="UpdateCustomerServlet?custEmail=<c:out value="${cust.custEmail}" />"><button type="button" class="btn-box">Edit</button></a>		<!-- update button style -->
	      </div>
	    </div>
	    </div></div>
