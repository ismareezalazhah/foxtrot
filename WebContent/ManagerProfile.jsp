	    ...
	    <div class="main-body">
	          ...
	          <div class="col-md-8">
	              <div class="card mb-3">
	                <div class="card-body">
	                  <div class="row">
	                    <div class="col-sm-3"><h6 class="mb-0">Staff ID</h6></div>
	                    <div class="col-sm-9 text-secondary"><c:out value="${st.staffid}"/></div>
	                  </div><hr>
	                  <div class="row">
	                    <div class="col-sm-3"><h6 class="mb-0">Name</h6></div>
	                    <div class="col-sm-9 text-secondary"><c:out value="${st.staffName}"/></div>
	                  </div><hr>
	                  <div class="row">
	                    <div class="col-sm-3"><h6 class="mb-0">Password</h6></div>
	                    <div class="col-sm-9 text-secondary"><c:out value="${st.staffPassword}"/></div>
	                  </div><hr>
	                  <div class="row">
	                    <div class="col-sm-3"><h6 class="mb-0">Contact No</h6></div>
	                    <div class="col-sm-9 text-secondary"><c:out value="${st.staffPhone}"/></div>
	                  </div><hr>
	                  <div class="row">
	                    <div class="col-sm-3"><h6 class="mb-0">Category</h6></div>
	                    <div class="col-sm-9 text-secondary"><c:out value="${st.staffCategory}"/></div>
	                  </div><hr>
	                  <div class="row">
	                    <div class="col-sm-12"> 
	                      <a href="ManagerUpdateDetailServlet?staffid=<c:out value="${st.staffid}" />"><button type="button" class="btn btn-default">Edit</button></a>		<!-- update button style -->
	                    </div>
	                  </div>
	                </div>
	              </div></div></div>
