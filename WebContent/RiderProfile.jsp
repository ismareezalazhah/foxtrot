...
<body class="sub_page">
  ...
  <div class="limiter"><div class="container-table100"><div class="wrap-table100"><div class="table100 ver2 m-b-110">
	...
	<main>
	    ...
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Rider ID</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${ri.riderid}"/></div></div>
	    <hr>
	    ...
	    <div class="col-sm-9 text-secondary"><c:out value="${ri.riderPassword}"/></div></div>
	    <hr>
	    ...
	    <hr>
	    <div class="row"><div class="col-sm-3"><b class="mb-0">Status</b></div>
	    <div class="col-sm-9 text-secondary"><c:out value="${ri.riderStatus}"/></div></div>
	    <hr>
	    <div class="row">
	      <div class="col-sm-12"> 
	        <a href="RiderUpdateDetailServlet?riderid=<c:out value="${ri.riderid}" />"><button type="button" class="btn-box">Edit</button></a>		<!-- update button style -->
	      </div>
	    </div>
	    </div></div>
